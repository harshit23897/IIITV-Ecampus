...
class QuotingTestCase(ConnectingTestCase):
    ...
    http://www.postgresql.org/docs/current/staticfiles/sql-syntax-lexical.html#SQL-SYNTAX-STRINGS
    http://www.postgresql.org/docs/current/staticfiles/runtime-config-compatible.html
    """
